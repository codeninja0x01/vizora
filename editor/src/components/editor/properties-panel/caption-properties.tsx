...
export function CaptionProperties({ clip }: CaptionPropertiesProps) {
  ...
  return (
    <div className="flex flex-col gap-1">
      <PropertySection title="Caption" defaultOpen={true}>
      ...
      <PropertySection title="Presets" defaultOpen={true}>
        <div className="flex flex-col gap-2">
          <label className="text-xs font-medium text-muted-foreground">
            Presets
          </label>
      ...
      <PropertySection title="Caption Colors" defaultOpen={false}>
        <div className="flex flex-col gap-2.5">
          {/* Appeared Color */}
          <div className="flex flex-col gap-1">
                  ...
                  <PopoverTrigger asChild>
                    ...
                    >
                      <div
                        ...
                        style={{
                          backgroundColor:
                            captionColors.activeFill || '#FF5700',
                        }}
                      />
                    </InputGroupButton>
                  </PopoverTrigger>
                  ...
                  <PopoverTrigger asChild>
                    ...
                    >
                      <div
                        ...
                        style={{
                          backgroundColor:
                            captionColors.background || '#000000',
                        }}
                      />
                    </InputGroupButton>
                  </PopoverTrigger>
